...
VALUES (1, 1, 9, '破滅の刃', 440, 1, NULL);
INSERT INTO order_details
VALUES (3, 1, 18, 'ブラーバジェット m6 エイロボット', 76860, 1, NULL);
INSERT INTO order_details
VALUES (2, 1, 20, 'スチーム式加湿器', 19500, 1, NULL);
INSERT INTO order_details
VALUES (4, 2, 1, '週刊少林ジャンプ', 390, 1, NULL);
INSERT INTO order_details
VALUES (5, 2, 8, 'ONE PEACH', 480, 1, NULL);
INSERT INTO order_details
VALUES (6, 2, 17, 'ルンヴァ i3 ロボット掃除機', 99800, 1, NULL);
INSERT INTO order_details
VALUES (7, 3, 21, 'ジャンボ グレー 猫用トイレ ディープパン', 3500, 2, NULL);
INSERT INTO order_details
VALUES (8, 3, 25, 'キャットフード インドアキャット シニア 7歳以上', 2473, 1, NULL);
INSERT INTO order_details
VALUES (9, 3, 10, 'シルバー(SV)ネックレス', 8800, 1, NULL);
INSERT INTO order_details
VALUES (10, 3, 15, 'スキーグローブ', 102300, 1, NULL);
INSERT INTO order_details
VALUES (11, 3, 24, '猫用おやつ にゃ～る グルメ まぐろ海鮮バラエティ 14グラム (x 120)', 4480, 2, NULL);
